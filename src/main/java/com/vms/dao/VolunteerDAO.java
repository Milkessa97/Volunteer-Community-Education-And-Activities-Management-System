...
public class VolunteerDAO {
    ...
    // 1. Count Assigned Lectures (Total)
    ...
    // 2. Count Total Students Reached
    ...
    // 3. Count Upcoming Sessions (Lectures scheduled for the future)
    ...
    // 5. Get Upcoming Schedule (Future events only)
