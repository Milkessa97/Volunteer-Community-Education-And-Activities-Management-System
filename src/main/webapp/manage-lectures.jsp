        ...
        <header class="border-b border-gray-200 bg-white sticky top-0 z-50">
            <div class="container mx-auto px-4 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <a href="admin?action=dashboard" class="text-sm font-semibold text-gray-600 hover:text-blue-600 transition-colors">Dashboard</a>
        ...
        <main class="container mx-auto px-4 py-8 max-w-6xl">
            <div class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p class="text-gray-600 text-lg">Review, edit, and monitor volunteer sessions across the platform.</p>
                </div>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 mb-8 flex flex-col md:flex-row gap-4 shadow-sm">
                ...
                <div class="relative">
                    <select id="statusFilter" class="appearance-none h-11 pl-4 pr-10 rounded-xl border border-gray-200 bg-gray-50 text-sm font-medium focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none cursor-pointer transition-all">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-50/50 border-b border-gray-200">
                                <th class="px-6 py-5 text-xs font-bold uppercase tracking-wider text-gray-500">Lecture Detail</th>
                                <th class="px-6 py-5 text-xs font-bold uppercase tracking-wider text-gray-500">Instructor</th>
                                <th class="px-6 py-5 text-xs font-bold uppercase tracking-wider text-gray-500">Date & Location</th>
                                <th class="px-6 py-5 text-xs font-bold uppercase tracking-wider text-gray-500">Status</th>
                                <th class="px-6 py-5 text-xs font-bold uppercase tracking-wider text-gray-500 text-right">Actions</th>
                            </tr>
                        </thead>
                        <tbody id="lectureTableBody" class="divide-y divide-gray-100">
                            <c:forEach var="lecture" items="${lectures}">
                                <tr class="hover:bg-blue-50/30 transition-colors group">
                                    <td class="px-6 py-5">
                                        <div class="font-bold text-gray-900 group-hover:text-blue-700 transition-colors">${lecture.title}</div>
                                        <div class="text-sm text-gray-500 line-clamp-1 max-w-xs">${lecture.description}</div>
                                    </td>
                                    <td class="px-6 py-5">
                                        <div class="flex items-center gap-2">
                                            <div class="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-xs font-bold text-gray-600">
                                                ${not empty lecture.instructor ? lecture.instructor.substring(0,1) : '?'}
                                            </div>
                                            <span class="text-sm font-medium text-gray-700">${not empty lecture.instructor ? lecture.instructor : 'Unassigned'}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-5 text-right">
                                        <div class="flex justify-end gap-1">
                                            ...
                                            <form action="admin" method="post" onsubmit="return confirm('Delete this lecture?');" class="inline">
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center">
                                            <p class="text-gray-500 font-medium">No lectures have been created yet.</p>
                                        </div>
                                    </td>
                                </tr>
                            </c:if>
