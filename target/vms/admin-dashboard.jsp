    ...
    <div class="min-h-screen">
        ...
        <main class="container mx-auto px-4 py-8 max-w-6xl">
            <div class="mb-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <a href="create-lecture.jsp" class="inline-flex items-center justify-center bg-blue-600 text-white h-12 px-8 rounded-xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-200">
                    + Create New Lecture
                </a>
            </div>
